    ...
    <>
      ...
      <Page>
        ...
        <HeroSubText>
          ...
          reconstituer l'histoire du patient sauf si les circonstances du moment
          présent le nécessitent. La Gestalt-thérapie met l'accent sur la prise
          de conscience du processus en cours, ce qui permet l'équilibre entre
          la personne qui vient consulter et son environnement. Elle s'intéresse
          au présent de chaque situation, c'est pourquoi on la classe dans le
          courant des psychologies humanistes ou existentielles.
        </HeroSubText>
